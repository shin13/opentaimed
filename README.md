...
|---|---|---|
| [`taiwan-fda-mcp/`](./taiwan-fda-mcp) | **shipped — v0.8.3** | An MCP server with 7 tools. Works with any MCP client (Claude Desktop, Claude Code, Codex…). |
...
| 部分 | 狀態 | 是什麼 |
|---|---|---|
| [`taiwan-fda-mcp/`](./taiwan-fda-mcp) | **已上線 — v0.8.3** | 有 7 個工具的 MCP server，可搭配任何 MCP client（Claude Desktop、Claude Code、Codex…）。 |
